...
function h(e, t) {
	...
	return (
		(o = c((o = d(o, [0, e.length])), (i = d(i, [0, e.length])))),
		(i = c(i, o)),
		(o = c((o = f(o)), (i = f(i)))),
		(i = c(i, o)),
				...
				var n = function (e) {
					...
					r = new Promise(function (r) {
						...
						o(e.bind(null, t), function () {
							...
							if (!e[0])
								return r(function () {
									return {error: w(e[1]), duration: i};
								});
							var c = e[1];
							if (n(c))
								return r(function () {
									return {value: c, duration: i};
								});
							r(function () {
...
function z(e) {
	for (
		...
		var c = i[o],
			u = r[c].join(" ");
		"style" === c ? D(a.style, u) : a.setAttribute(c, u);
	}
	return a;
}
function D(e, t) {
...
function N() {
	...
	return [
		m(p(e.availTop), null),
		m(p(e.width) - p(e.availWidth) - m(p(e.availLeft), 0), null),
		m(p(e.height) - p(e.availHeight) - m(p(e.availTop), 0), null),
		m(p(e.availLeft), null),
	];
}
function W(e) {
...
var te = {
	fonts: function () {
		return E(function (e, t) {
			...
			for (var l = 0; l < L.length; l++)
				(o[L[l]] = u[l].offsetWidth), (i[L[l]] = u[l].offsetHeight);
		...
		return (function (e, t) {
			...
			return E(function (n, a) {
				...
				(c.width = t + "px"),
					...
					A()
						? (i.style.zoom = "" + 1 / a.devicePixelRatio)
						: x() && (i.style.zoom = "reset");
				var u = o.createElement("div");
				return (
					(u.textContent = r(Array((t / 20) << 0))
						.map(function () {
							return "word";
						})
						.join(" ")),
			...
			for (var g = 0, b = Object.keys(ee); g < b.length; g++) {
	...
	reducedMotion: function () {
		return !!X("reduce") || (!X("no-preference") && void 0);
	},
	hdr: function () {
		return !!Y("high") || (!Y("standard") && void 0);
	},
	math: function () {
		var e,
			t = Z.acos || Q,
		...
		return {
			...
			acosh: n(1e308),
			acoshPf: ((e = 1e154), Z.log(e + Z.sqrt(e * e - 1))),
			...
			atanh: o(0.5),
			atanhPf: (function (e) {
				return Z.log((1 + e) / (1 - e)) / 2;
			})(0.5),
			atan: i(0.5),
			sin: c(-1e300),
			sinh: u(1),
			sinhPf: (function (e) {
				return Z.exp(e) - 1 / Z.exp(e) / 2;
			})(1),
			...
			tanh: f(1),
			tanhPf: (function (e) {
				return (Z.exp(2 * e) - 1) / (Z.exp(2 * e) + 1);
			})(1),
			exp: h(1),
			expm1: v(1),
			expm1Pf: (function (e) {
...
export {
	...
	ue as default,
	P as getFullscreenElement,
	U as getScreenFrame,
	ae as hashComponents,
	_ as isAndroid,
	A as isChromium,
	S as isDesktopSafari,
	C as isEdgeHTML,
	M as isGecko,
	k as isTrident,
	x as isWebKit,
	ce as load,
	y as loadSources,
	se as murmurX64Hash128,
	oe as prepareForSources,
	te as sources,
};
